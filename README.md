...
```text
Bucket name                 : myfirstbucket-paul-01(instead of "paul", students use their  own clarusway student number)
Region                      : N.Virginia
...
- Upload `cat2.jpg` and `cat3.jpg` files under `myfirstbucket-paul-01` bucket.
